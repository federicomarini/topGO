...
We assume the user has a good understanding of GO, see [@GOC01;@YonRhee2008], and is familiar with gene set enrichment tests. Also this document requires basic knowledge of R language.
...
```{r topGOclasses, echo=FALSE, fig.cap="The test statistics class structure."}

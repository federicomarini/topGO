...
the dataset. A two-sided $t$-test can by applied using the function `getPvalues` (a wraping function for 
...
-  Tests based on gene {\bf counts}. This is the most popular family of tests, given that 
  ...
  Fisher's exact test, Hypegeometric test and binomial test belong to this family. @Draghici2006
